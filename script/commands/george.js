...
const { threadID, messageID, body } = event;
  const rand = ["Hi user if you don't know how to use me just type <harold help>","Hey There user I'm Harold Hutchins Bot how can I assist you today? 😊", "Hello there user can I sing for you? 🥰", "Hello There user did you know that I can sing, download facebook videos, search image and more...", "Hello There user I'm Harold Hutchins Bot Modified By Jonell Magallanes and the owner is Deku."];
...
Just type harold can you sing (title of song)> or george sing (title of song)> as long as there is the word sing and the title of the song, it can automatically detect it


•HAROLD CAN DOWNLOAD FACEBOOK VIDEOS.

Just type <harold can you download this facebook video (fb video url)> or <george download this facebook video (fb video url)> as long as there is the word ‘facebook video’ or ‘download’ and the fb video url, it can automatically detect it.


•HAROLD CAN SEARCH IMAGES.

Just type <harold can you search an image of (your search)> or <george image of (your search)> as long as there is the word ‘image’ or ‘image of’ and your search, it can automatically detect it.
...
Just type <george can you give me the lyrics of (song name)> or <george give me a lyrics of (song name)> as long as there's a word ‘lyrics of’ and the song name it will be automatically detected.
...
Just type <harold send the tiktok video of (your search)> or <midoriya send the tiktok video of (your search)> or <harold send a tiktok video of (your search)>
